...
However, it does not cover the use of regularization and optimizers on each layer. These can be found in the API reference [here](../API/Models/NeuralNetworks.md).
