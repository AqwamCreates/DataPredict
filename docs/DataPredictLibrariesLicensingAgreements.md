...
* Tooling License (Roblox Plugins Are Not Included)
  ...
  * A maximum of 30% with a minimum of 10% of gross revenue per user for plans or products that contains features that uses DataPredict™, DataPredict™ Neural and DataPredict™ Axon. If subscription-based, then it will be charged monthly.
...
* [Childhood-Appreciation License](https://github.com/AqwamCreates/DataPredict/blob/main/docs/DataPredictLibrariesLicensingAgreements/) (Incomplete)
   ...
   * Only applicable to studios / individuals that created these games:
     ...
     * [Lumber Tycoon 2](https://www.roblox.com/games/13822889/Lumber-Tycoon-2)
