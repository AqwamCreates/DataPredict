...
A Queued Reinforcement Neural Network is a neural network that has the capability of reinforcing and back propagate through time. This model can be considered as a cousin of Recurrent Neural Networks.
