...
| It is a required part for the company's assets like the company's source codes, even if the usage is optional.           | 4                 | The library is now in the employees' awareness and the top-level executives may be involved.                                                                                                                             |
| The violator claims to have signed an asset's licensing agreement with me, but I have no such agreement unless I forgot. | ∞                 | The licensing agreement can only be made by top-level leader(s) and requires a direct interaction with me. Hence, it is an active usage due to convincing others that the library is licensed for that particular asset. |
