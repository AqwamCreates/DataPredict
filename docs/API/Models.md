...
| [OneClassPassiveAggressiveClassifier](Models/OneClassPassiveAggressiveClassifier.md)                             | OC-PA-C                | Fast Purchase Likelihood Estimation, Player Churn Prediction, Confidence Prediction      |
