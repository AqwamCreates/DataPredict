...
A QueuedReinforcementNeuralNetwork (QR-NN) is a neural network that has the ability to reinforce and back propagate through time. This model can be considered as a cousin of Recurrent Neural Network (RNN).
