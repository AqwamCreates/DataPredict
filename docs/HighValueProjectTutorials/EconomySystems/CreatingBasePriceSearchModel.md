...
| MeanShift               | Only 1.                          | Finds the most densest part of the cluster where almost all players tend to make a purchase for that particular price and item. | Popular Base Price.
