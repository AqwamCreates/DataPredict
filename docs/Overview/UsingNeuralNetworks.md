...
For regularization, you can use one regularization object for each layer. But you can also use single regularization object for all layers. The examples are shown below.
