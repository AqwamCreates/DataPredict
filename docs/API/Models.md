...
| [BayesianLinearRegression](Models/BayesianLinearRegression.md) (Not Recommended)           | None            | Final Solution Time-To-Leave Prediction And In-Game Currency Price Generation With Probability Estimation |
