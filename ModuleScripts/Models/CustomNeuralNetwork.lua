...
CustomNeuralNetworkModel = {}

CustomNeuralNetworkModel.__index = CustomNeuralNetworkModel

setmetatable(CustomNeuralNetworkModel, BaseModel)
...
function CustomNeuralNetworkModel:convertLabelVectorToLogisticMatrix(modelParameters, labelVector, classesList)
...
function CustomNeuralNetworkModel:forwardPropagate(featureMatrix)
...
function CustomNeuralNetworkModel:backPropagate(lossMatrix, zTable)
...
function CustomNeuralNetworkModel:calculateDelta(forwardPropagateTable, backpropagateTable, numberOfData)
...
function CustomNeuralNetworkModel:gradientDescent(deltaTable, numberOfData)
...
function CustomNeuralNetworkModel:calculateCost(allOutputsMatrix, logisticMatrix, numberOfData)
...
function CustomNeuralNetworkModel:getLabelFromOutputVector(outputVector, classesList)
...
function CustomNeuralNetworkModel:checkIfRewardAndPunishValueAreGiven(rewardValue, punishValue)
...
function CustomNeuralNetworkModel.new(maxNumberOfIterations, learningRate, targetCost)

	local NewCustomNeuralNetworkModel = BaseModel.new()

	setmetatable(NewCustomNeuralNetworkModel, CustomNeuralNetworkModel)

	NewCustomNeuralNetworkModel.maxNumberOfIterations = maxNumberOfIterations or defaultMaxNumberOfIterations

	NewCustomNeuralNetworkModel.learningRate = learningRate or defaultLearningRate

	NewCustomNeuralNetworkModel.targetCost = targetCost or defaultTargetCost

	NewCustomNeuralNetworkModel.validationFeatureMatrix = nil

	NewCustomNeuralNetworkModel.validationLabelVector = nil
	
	NewCustomNeuralNetworkModel.numberOfNeuronsTable = {}
	
	NewCustomNeuralNetworkModel.RegularizationTable = {}
	
	NewCustomNeuralNetworkModel.OptimizerTable = {}
	
	NewCustomNeuralNetworkModel.ClassesList = {}
	
	NewCustomNeuralNetworkModel.addBiasNeuronTable = {}
	
	NewCustomNeuralNetworkModel.activationFunctionTable = {}
	
	NewCustomNeuralNetworkModel.previousDeltaMatricesTable = {}

	return NewCustomNeuralNetworkModel

end

function CustomNeuralNetworkModel:setParameters(maxNumberOfIterations, learningRate, targetCost)
...
function CustomNeuralNetworkModel:predict(featureMatrix)
...
function CustomNeuralNetworkModel:reinforce(featureVector, label, rewardValue, punishValue)
...
function CustomNeuralNetworkModel:getClassesList()
	
	return self.ClassesList
	
end

function CustomNeuralNetworkModel:setClassesList(classesList)

	self.ClassesList = classesList

end

function CustomNeuralNetworkModel:showDetails()
...
return CustomNeuralNetworkModel
