...
| [BernoulliNaiveBayes](Models/BernoulliNaiveBayes.md)*                                | None                           | 💾 ⚡ 🟢 🟡 ⚠️ | Binary Action Prediction (e.g. Jump Or Not), Quick Decision Filters                                             |
| [ComplementNaiveBayes](Models/ComplementNaiveBayes.md)*                              | None                           | 💾 ⚡ 🟢 🟡 ⚠️ | Imbalanced Class Prediction (e.g. Rare Choices, Niche Paths)                                                    |
| [CategoricalNaiveBayes](Models/CategoricalNaiveBayes.md)*                            | None                           | 💾 ⚡ 🟢 🟡 ⚠️ | Player Choice Prediction (e.g. Weapon Type, Character Class, Map Region Selection)                              |
...
| [TabularDoubleQLearningV1](Models/TabularDoubleQLearningV1                                                           | Double Q-Learning (2010)  | 💾 🛡️ 🟢   | Best Self-Learning Grid AIs     |
...
> ❗Implementation Issue 🔰 Beginner Algorithm 💾 Data Efficient ⚡ Computationally Efficient 🟤 Noise Resistant 🟢 Online 🟡 Session-Adaptive / Offline 🔴 Assumption-Heavy
