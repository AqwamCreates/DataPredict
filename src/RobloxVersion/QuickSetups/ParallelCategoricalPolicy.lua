...
return ParallelCategoricalPolicyQuickSetup	NewParallelCategoricalPolicyQuickSetup.shareCurrentCValue = NewParallelCategoricalPolicyQuickSetup:getValueOrDefaultValue(parameterDictionary.shareCurrentCValue or defaultShareCurrentCValue)
