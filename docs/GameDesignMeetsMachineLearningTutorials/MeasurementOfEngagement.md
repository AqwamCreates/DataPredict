...
| Map Coverage                         | The more the player is engaged, the more the player explores. Even if the player lost, confused, or unable to find the objective. it implies engagement to solve a problem. |
