...
* Almost all model parameters are stored as tables of tables. This reduces the number of bytes needed to store inside Roblox's DataStores compared to dictionaries.
