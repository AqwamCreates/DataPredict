...
However, this require setting the Neural Network's parameters to these settings temporarily so that it can be biased to "NoEvent" at start up as shwon below.
