# [API Reference](../../API.md) - [Models](../Models.md) - LevenbergMarquardtRegression

LevenbergMarquardtRegression is a supervised machine learning model that predicts continuous values (e.g. 1.2, -32, 90, -1.2 and etc.). It uses iterative calculations to find the best model parameters.
