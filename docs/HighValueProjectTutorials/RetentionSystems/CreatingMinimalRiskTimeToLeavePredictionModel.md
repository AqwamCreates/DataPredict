...
| Recursive Least Squares    | Best for training with streams of data, not requiring you to actually need the full dataset.      | Has the highest number of parameters to adjust compared to others in this list. |
