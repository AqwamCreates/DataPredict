# [API Reference](../../API.md) - [Models](../Models.md) - TabularREINFORCE

TabularREINFORCE is a tabular storage with reinforcement learning capabilities. It can predict any positive numbers of discrete values.
...
```
TabularREINFORCE.new(discountFactor: number): ModelObject
```
...
```
TabularREINFORCE:setParameters(discountFactor: number)
```
