...
| [LinearRegressionCovariancePreconditionedVariant](Models/LinearRegressionCovariancePreconditionedVariant.md)               | LR                                         | 💾 ⚡ 🟢 🟡 🛡️  | Faster General Time-To-Leave Prediction And In-Game Currency Price Generation                                   |
...
| [SupportVectorRegressionCovariancePreconditionedVariant](Models/SupportVectorRegressionCovariancePreconditionedVariant.md) | SVR                                        | 💾 ⚡ 🟢 🟡 🛡️  | Faster Real-Time Constrained Time-To-Leave Prediction And In-Game Currency Price Generation              |
...
| [SupportVectorMachineCovariancePreconditionedVariant](Models/SupportVectorMachineCovariancePreconditionedVariant.md) | SVM                            | 💾 ⚡ 🟢 🟡 🛡️   Faster Real-Time Boundary-Based Prediction                                                                       |
