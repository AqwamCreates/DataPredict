# [Retention Systems](../RetentionSystems.md) - Creating Probability-To-Interact Prediction Model
...
local InteractionPredictionModel = DataPredict.Models.BinaryRegression.new({maximumNumberOfIterations = 1, learningRate = 0.3})
