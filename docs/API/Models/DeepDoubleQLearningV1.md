# [API Reference](../../API.md) - [Models](../Models.md) - DeepDoubleQLearningV1 (Deep Double Q Network)
...
```
DeepDoubleQLearning.new(discountFactor: number, EligibilityTrace: EligibilityTraceObject): ModelObject
```
