...
| 3        | Expectation-Maximization         | Non-Incremental, Probabilistic | Good for anomaly detection; requires retraining, heavier to run, can produce multiple normal clusters.          |
