# [Retention Systems](../RetentionSystems.md) - Creating Advanced Time-To-Leave Prediction Model
...
local LeavePredictionModel = DataPredict.Models.FactorizationMachine.new({maximumNumberOfIterations = 1, learningRate = 0.3, latentFeatureCount = 3})
