...
If you suspect that any license violations, including those involving your own company/group, have occurred, you may be eligible for a bounty reward of up to 30% of the value of the violating company/group, subject to the following terms:
...
* Bounty Reward Calculation:
  ...
  * The maximum bounty reward is 30% of the value of the violating company/group. The actual reward may be lower depending on the specifics of the case, such as the complexity of the violation, the difficulty in proving it, and the overall damages incurred.
...
* Level of Responsibility:
  ...
  * Higher-Level Decision Makers: If the violation is traced back to individuals in higher positions (such as CEO, CFO, CTO, Project Manager, etc.), the violation is considered to be more systematic or institutional in nature. This could indicate that the violation was part of the organization's strategy or internal decision-making.
    ...
    * For example:
      ...
      * CEO / Executive Level: Highest bounty reward due to the potential for widespread, organizational-level violations (up to 30% of the value).
...
| Total Evidence Point(s) | Evidence Strength | Remarks                                                                   |
|-------------------------|-------------------|---------------------------------------------------------------------------|
| 1 - 3                   | Weak              | This case will not be pursued any further unless there are new evidence.  |
...
| It is a required part for the company's assets like the company's source codes, even if the usage is optional.                        | 4                 | The library is now in the employees' awareness and the top-level leader(s) may be involved.                                                                                                                                                                                            |
| Attempts of reverse engineering or replicating the library, regardless of the presence of other libraries of similar functionalities. | ∞                 | It is extremely unlikely for an employee find it is worth it to replicate the whole library when they can use the library directly. The only way for this action to make sense is to cover the tracks once the library is replicated or the employee leaves middle of the replication. |
| The violator claims to have signed an asset's licensing agreement with me, but I have no such agreement unless I forgot.              | ∞                 | The licensing agreement can only be made by the top-level leader(s) and requires a direct interaction with me. Hence, it is an active usage due to convincing others that the library is licensed for that particular asset.                                                           |
...
* Maximum reward: Up to 30% of the value of the violating company/group.
