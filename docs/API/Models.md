...
| [SupportVectorRegressionNaturalGradientVariant](Models/SupportVectorRegressionNaturalGradientVariant.md) | SVR                                        | 💾 ⚡ 🟢 🟡      | Faster Real-Time Constrained Time-To-Leave Prediction And In-Game Currency Price Generation              |
...
| [LevenbergMarquardt](Models/LevenbergMarquardt.md)                                                       | Non-Linear Least Squares Regression / NLLS | ⚡ 🟢 🟡        | Fast Train Time-To-Leave Prediction And In-Game Currency Price Generation For Non-Linear Patterns        |
...
| [SupportVectorMachineNaturalGradientVariant](Models/SupportVectorMachineNaturalGradientVariant.md)                                 | SVM                            | 🟢 🟡           | Faster Real-Time Boundary-Based Prediction                                                                       |
| [SupportVectorMachineIterativeReweightedLeastSquaresVariant](Models/SupportVectorMachineIterativeReweightedLeastSquaresVariant.md) | SVM                            | 💾 ⚡ 🟢 🟡    | Faster & Flexible Real-Time Boundary-Based Prediction                                                            |
