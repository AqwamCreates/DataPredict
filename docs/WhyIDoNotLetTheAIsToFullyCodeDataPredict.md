...
* For things that are well-known like Neural Networks, they suffer certain code rigidity which would be extremely bad if you want to do optimizations on the existing codes. This is especially noticeable if you have hand-crafted the neural network codes that have all the hand-crafted optimizations. If you deviate from AIs' internal knowledge, you somehow turn a formerly correct and optimized codes for the first derivatives to being wrong or reverted back to whatever AIs' idea of the "correct" implementation for these codes. Even if you tell the AIs' not to touch it at all costs and at all times, the AI will literally change those correct and optimized codes if they see that the codes that AIs generated themselves produces wrong results and they insist that the results are incorrect because of the codes that I told them not to touch at all costs and at all times.
