...
* [Contributor License Version](https://github.com/AqwamCreates/DataPredict/blob/main/docs/DataPredictLibrariesLicensingAgreements/) (Incomplete)
   ...
   * If a company employs strong DataPredict contributor (more than or equal to 10% contribution) with a guarantee 1 year of employment, the company may request three non-transferrable and royalty-free licenses for their projects. This license is valid as long as the DataPredict contributor remained employed in the same company.
