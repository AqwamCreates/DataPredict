...
| 🔢   | Integer Output             | Generate (near) integer values only.                    |
...
> ❗Implementation Issue 🔰 Beginner Model 💾 Data Efficient ⚡ Computationally Efficient 🛡️ Noise Resistant 🟢 Online 🟡 Session-Adaptive / Offline ⚠️ Assumption-Heavy ⚙️ Configuration-Heavy ➕ Positive Output 🔢 Integer Output
...
| [LeastTrimmedSquaresRegression](Models/LeastTrimmedSquaresRegression.md)*                        | LTS                                        | 💾 🟡 ⚠️        | Robust Time-To-Leave Prediction And In-Game Currency Price Generation With Probability Estimation        |
...
| [ExpectationMaximization](Models/ExpectationMaximization.md)                                                           | EM              | 🟢 🟡     | Density Grouping, Hacking Detection, Anomaly Detection              |
| [MeanShift](Models/MeanShift.md)                                                                                       | None            | 🛡️ 🟢 🟡 | Boss Spawn Location Search Based On Players' Locations               |
