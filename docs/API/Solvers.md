...
|-----------------------------------------------------------|-------------------|---------------------------------------|---------------------------------------------------|-------------------------|------------|---------------------------------------------------------------------|
| [Gradient](Solvers/Gradient.md)                           | Low               | High                                  | Very High; O(mn) Operations Reduced               | Very High               | 🔰 📈     | General-Purpose                                                      |
| [ConjugateGradient](Solvers/ConjugateGradient.md)         | Medium            | Medium                                | Medium-High; O(n^2m + mn) Operations Reduced      | High                    | 🛡️ 📈     | Large Datasets + Most Values Are Zero (a.k.a. Sparse Data)           |
| [GaussNewton](Solvers/GaussNewton.md)                     | Medium-High       | Medium                                | Very High; O(n^3 + n^2m + mn) Operations Reduced  | Medium                  | 🔢 🎯     | Small-Medium Datasets + Well-Defined Problems                        |
| [LevenbergMarquardt](Solvers/LevenbergMarquardt)          | Medium-High       | Medium                                | Very High; O(n^3 + n^2m + 2mn) Operations Reduced | Medium                  | 🔢 ⚠️     | Small-Medium Datasets + Poorly-Defined Problems                      |
| [IterativelyReweighted](Solvers/IterativelyReweighted.md) | Medium            | Medium                                | Medium; O(mn) Operations Reduced                  | Medium                  | 🔢 🛡️	    | Individual Datapoints Have Different Contribution To Feature Weights |
| [GreedyCoordinate](Solvers/GreedyCoordinate.md)           | Low               | High                                  | Very High; O(mn) Operations Reduced               | Very Low                | 🛡️ 📈     | Large Datasets + Most Values Are Zero (a.k.a. Sparse Data)           |
| [RandomCoordinate](Solvers/RandomCoordinate.md)           | Low               | Very High                             | Very High; O(mn) Operations Reduced               | Very Low                | 🛡️ 📈     | Extremely Large Datasets                                             |
