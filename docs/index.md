...
By using or possesing any copies of this library, you agree to our [Terms and Conditions](TermsAndConditions.md). In other words, attribution is required when using this library. Additionally, there are limitations when using this library for commercial purposes.
