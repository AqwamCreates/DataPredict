...
PoissonRegression is a supervised machine learning model that predicts positive integers. It uses iterative calculations to find the best model parameters.
