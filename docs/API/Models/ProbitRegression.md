# [API Reference](../../API.md) - [Models](../Models.md) - ProbitRegression
...
```
ProbitRegression.new(maximumNumberOfIterations: integer, learningRate: number): ModelObject
```
...
```
ProbitRegression:setOptimizer(Optimizer: OptimizerObject)
```
...
```
ProbitRegression:setRegularizer(Regularizer: RegularizerObject)
```
