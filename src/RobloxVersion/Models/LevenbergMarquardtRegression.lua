...
local LevenbergMarquardtRegressionModel = {}

LevenbergMarquardtRegressionModel.__index = LevenbergMarquardtRegressionModel

setmetatable(LevenbergMarquardtRegressionModel, IterativeMethodBaseModel)
...
function LevenbergMarquardtRegressionModel.new(parameterDictionary)
	...
	local NewLevenbergMarquardtRegressionModel = IterativeMethodBaseModel.new(parameterDictionary)

	setmetatable(NewLevenbergMarquardtRegressionModel, LevenbergMarquardtRegressionModel)

	NewLevenbergMarquardtRegressionModel:setName("LevenbergMarquardtRegression")
	
	NewLevenbergMarquardtRegressionModel.lambda = parameterDictionary.lambda or defaultLambda
	
	NewLevenbergMarquardtRegressionModel.learningRate = parameterDictionary.learningRate or defaultLearningRate

	return NewLevenbergMarquardtRegressionModel

end

function LevenbergMarquardtRegressionModel:train(featureMatrix, labelVector)
...
function LevenbergMarquardtRegressionModel:predict(featureMatrix)
...
return LevenbergMarquardtRegressionModel
